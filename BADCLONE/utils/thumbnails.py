...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("BADCLONE/assets/font2.ttf", 32)
        regular_font = ImageFont.truetype("BADCLONE/assets/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "BADCLONE/assets/play_icons.png"
